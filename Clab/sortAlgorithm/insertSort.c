...
{
int *edge,*point,temp;
int times=1;///////////////////////////////////////////////////////this is times of loop
for ( edge=point=arr+1 ; edge<arr+size  ; point=(++edge) )	//在edge前面的数可认为已排好序
	{
		temp=*point;
		for ( ;(point != arr) && ((*(point-1)) > temp); point-- )
			{///////////////////////////////////////////////
				*point=*(point-1);	//当前面的数比要移动的数更大，就将前面的数后移
				times++;///////////////////////////////////////
			}////////////////////////
		*point=temp;
	}
